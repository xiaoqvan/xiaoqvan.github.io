...
myhkScript.src = `https://myhkw.cn/api/player/${musicConfig.playerId}` // 使用配置文件中的playerId
myhkScript.id = 'myhk'
myhkScript.setAttribute('key', musicConfig.playerId.toString()) // 使用配置文件中的playerId
